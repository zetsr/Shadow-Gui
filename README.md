...
> [!IMPORTANT]
> README.md 的 API 文档落后当前版本，请以 [Shadow.h](https://github.com/zetsr/Shadow-Gui/blob/main/Shadow-Gui/external/Shadow-Gui/include/Shadow.h) 和 [Release list](https://github.com/zetsr/Shadow-Gui/releases) 为准。
